...
function request_appdata(host, port, params)
  ...
  local xmldata = {
    "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>\r\n\z".."<!DOCTYPE NFuseProtocol SYSTEM \"NFuse.dtd\">\r\n\z".."<NFuseProtocol version=\"5.0\"><RequestAppData><Scope traverse=\"",
    scope,
    '" /><ServerType>',
    server_type,
...
function request_address(host, port, flags, appname)
  ...
  local xmldata = {
    "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>\r\n\z".."<!DOCTYPE NFuseProtocol SYSTEM \"NFuse.dtd\">\r\n\z".."<NFuseProtocol version=\"4.1\"><RequestAddress>"
  }
...
function request_server_data(host, port, params)
  ...
  local xmldata = {
    "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>\r\n\z".."<!DOCTYPE NFuseProtocol SYSTEM \"NFuse.dtd\">\r\n\z".."<NFuseProtocol version=\"1.1\"><RequestServerData>"
  }
...
function request_protocol_info( host, port, params )
  ...
  local xmldata = {
    "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>\r\n\z".."<!DOCTYPE NFuseProtocol SYSTEM \"NFuse.dtd\">\r\n\z".."<NFuseProtocol version=\"1.1\"><RequestProtocolInfo>"
  }
...
function request_validate_credentials(host, port, params )
  ...
  local xmldata = {
    "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>\r\n\z".."<!DOCTYPE NFuseProtocol SYSTEM \"NFuse.dtd\">\r\n\z".."<NFuseProtocol version=\"5.0\"><RequestValidateCredentials><Credentials>"
  }
...
function request_reconnect_session_data(host, port, params)
  ...
  local xmldata = {
    "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>\r\n\z".."<!DOCTYPE NFuseProtocol SYSTEM \"NFuse.dtd\">\r\n\z".."<NFuseProtocol version=\"5.0\"><RequestReconnectSessionData><Credentials>"
  }
